...
const p = ['<p>error excepturi harum voluptas placeat, sequi enim voluptatum, consequatur itaque doloribus nesciunt architecto mollitia earum rerum deleniti quibusdam exercitationem?</p>','<p>error excepturi harum voluptas placeat, sequi enim voluptatum, consequatur itaque doloribus nesciunt architecto mollitia earum rerum deleniti quibusdam exercitationem?</p>']
...
const div= ['<div>','<span>I should be In Line</span>','</div>','<div>','<span>Me too.</span>','</div>']
